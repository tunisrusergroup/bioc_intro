...
Welcome to this **Bioconductor - The Carpentries** course designed to introduce you to the fundamentals of data analysis using **R** and **Bioconductor**. This course will guide you through working with data, manipulating it effectively, and visualizing it to gain insights in the context of **bioinformatics**.
...
-   [Course GitHub](https://github.com/tunisrusergroup/bioc_intro) – Contains all the materials and code examples used in this course.
