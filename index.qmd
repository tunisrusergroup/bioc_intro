...
-   [Course](https://github.com/tunisrusergroup/bioc_intro)[ Repository (GitHub)](https://github.com/your-repo-link) – Contains all the materials and code examples used in this course.
...
| Day | Time | Session |
|------------------------|------------------------|------------------------|
| **Day 1** | **Morning** | Data organisation with spreadsheets, R and RStudio, Introduction to R |
|  | **Afternoon** | Introduction to R (suite), Data Manipulation with dplyr |
| **Day 2** | **Morning** | Data Manipulation with dplyr |
|  | **Afternoon** | Data Visualization with ggplot2 |
